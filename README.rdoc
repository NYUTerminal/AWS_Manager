...
* http://localhost:3000/aws/start (To start AWS EC2 Server)
 
* http://localhost:3000/aws/stop (To stop AWS EC2 Server)

* http://localhost:3000/aws/status (To check status of AWS EC2 Server)
